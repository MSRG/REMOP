...
OptionValueSet &GetValueForOption(const string &name) {
	static unordered_map<string, OptionValueSet> value_map = {
	    ...
	    {"force_nested_loop_join", {Value(true)}},
	    ...
	    {"operator_memory_optimizations", {Value(true)}},
	    {"operator_memory_budget", {Value("1.0 GiB"), Value("1.0 GiB")}},
	    {"operator_sort_input_buffer_ratio", {Value(0.3)}},
	    {"operator_nlj_input_buffer_ratio", {Value(0.4)}},
	    {"operator_nlj_short_table_buffer_ratio", {Value(0.2)}},
	    {"operator_nlj_outer_table_buffer_ratio", {Value(0.8)}},
	    {"operator_kway_merge_k", {Value::BIGINT(8)}},
	    {"operator_kway_merge_adaptive", {Value(false)}},
	    {"operator_kway_merge_input_buffer_ratio", {Value(0.7)}},
