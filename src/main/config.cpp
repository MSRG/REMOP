...
static const ConfigurationOption internal_options[] = {
    ...
    DUCKDB_LOCAL(ForceNestedLoopJoin),
    DUCKDB_LOCAL(PreferRangeJoins),
    DUCKDB_GLOBAL(OperatorMemoryOptimizations),
    DUCKDB_GLOBAL(OperatorMemoryBudget),
    DUCKDB_GLOBAL(OperatorSortInputBufferRatio),
    DUCKDB_GLOBAL(OperatorNLJInputBufferRatio),
    DUCKDB_GLOBAL(OperatorNLJShortTableBufferRatio),
    DUCKDB_GLOBAL(OperatorNLJOuterTableBufferRatio),
    DUCKDB_GLOBAL(OperatorKWayMergeK),
    DUCKDB_GLOBAL(OperatorKWayMergeAdaptive),
    DUCKDB_GLOBAL(OperatorKWayMergeInputBufferRatio),
