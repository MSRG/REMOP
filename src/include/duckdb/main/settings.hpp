...
struct ForceNestedLoopJoin {
	static constexpr const char *Name = "force_nested_loop_join";                                           // NOLINT
	static constexpr const char *Description = "DEBUG SETTING: force use of nested loop join for all joins"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::BOOLEAN;                                 // NOLINT
	static void SetLocal(ClientContext &context, const Value &parameter);
	static void ResetLocal(ClientContext &context);
	static Value GetSetting(const ClientContext &context);
...
struct OperatorMemoryOptimizations {
	static constexpr const char *Name = "operator_memory_optimizations"; // NOLINT
	static constexpr const char *Description =
	    "Enable optimized operator wrappers controlled by OperatorMemoryPolicy"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::BOOLEAN;      // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct OperatorMemoryBudget {
	static constexpr const char *Name = "operator_memory_budget"; // NOLINT
	static constexpr const char *Description =
	    "Memory budget for optimized operators (e.g. 1GB, 0 = use memory_limit)"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::VARCHAR;       // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
};

struct OperatorSortInputBufferRatio {
	static constexpr const char *Name = "operator_sort_input_buffer_ratio"; // NOLINT
	static constexpr const char *Description =
	    "Sort merge input buffer ratio (0.0-1.0, output = 1 - input). Cannot change while operator_memory_optimizations is enabled"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::DOUBLE;                                                           // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
};

struct OperatorNLJInputBufferRatio {
	static constexpr const char *Name = "operator_nlj_input_buffer_ratio"; // NOLINT
	static constexpr const char *Description =
	    "NLJ input buffer ratio (0.0-1.0, output = 1 - input). Cannot change while operator_memory_optimizations is enabled"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::DOUBLE;                                                    // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct OperatorNLJShortTableBufferRatio {
	static constexpr const char *Name = "operator_nlj_short_table_buffer_ratio"; // NOLINT
	static constexpr const char *Description =
	    "NLJ inner/short table buffer ratio (0.0-1.0, outer/long = 1 - inner). Cannot change while operator_memory_optimizations is enabled"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::DOUBLE;                                                        // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct OperatorNLJOuterTableBufferRatio {
	static constexpr const char *Name = "operator_nlj_outer_table_buffer_ratio"; // NOLINT
	static constexpr const char *Description =
	    "NLJ outer/long table buffer ratio (0.0-1.0, inner/short = 1 - outer). Cannot change while operator_memory_optimizations is enabled"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::DOUBLE;                                                        // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct OperatorKWayMergeK {
	static constexpr const char *Name = "operator_kway_merge_k"; // NOLINT
	static constexpr const char *Description =
	    "K-way merge fan-in (minimum 2). Cannot change while operator_memory_optimizations is enabled"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::BIGINT; // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
};

struct OperatorKWayMergeAdaptive {
	static constexpr const char *Name = "operator_kway_merge_adaptive"; // NOLINT
	static constexpr const char *Description =
	    "Enable adaptive K selection for k-way merge. Cannot change while operator_memory_optimizations is enabled"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::BOOLEAN; // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct OperatorKWayMergeInputBufferRatio {
	static constexpr const char *Name = "operator_kway_merge_input_buffer_ratio"; // NOLINT
	static constexpr const char *Description =
	    "K-way merge input buffer ratio (0.0-1.0, output = 1 - input). Cannot change while operator_memory_optimizations is enabled"; // NOLINT
	static constexpr const LogicalTypeId InputType = LogicalTypeId::DOUBLE; // NOLINT
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
