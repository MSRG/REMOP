...
INSTANTIATE_VECTOR(vector<duckdb::unique_ptr<duckdb::RowDataBlock>>)
...
template class std::unordered_map<duckdb::string, uint64_t>;
template class std::unordered_map<duckdb::string, duckdb::vector<duckdb::string>>;
template class std::unordered_map<duckdb::string, std::pair<uint64_t, duckdb::Expression *>>;
// template class std::unordered_map<string, TableBinding>;
template class std::unordered_map<duckdb::string, duckdb::SelectStatement *>;
